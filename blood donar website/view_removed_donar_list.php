...
<body class="home">
    ...
    $sql ="SELECT * from donar_backup";
        $res=$conn->query($sql);
        // echo $_SESSION["name"];
?>
    <h1>REMOVED DONAR LIST</h1>
    ...
    <table>
        ...
        if (isset($_POST['search_bg'])) {
            $bg=$_POST["bg"];
            $bg_sql ="SELECT * from donar_backup where bloodgroup like '%$bg%'";
        ...
        <tr>
            ...
            <td>
            <?php
                echo "<a href='activate_donar.php?id=$row[id]' class='act'>ACTIVATE</a>";
                ?>
            </td>
            <td>
            <?php
                echo "<a href='permanent_delete_donar.php?id=$row[id]' class='del'>DELETE</a>";
                ?>
            </td>
        <tr>
            <?php
         ...
         if (isset($_POST['search_city'])) {
            $city=$_POST["city"];
            $city_sql ="SELECT * from donar_backup where city like '%$city%'";
