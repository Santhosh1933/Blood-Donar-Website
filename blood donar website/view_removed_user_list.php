...
<body class="home">
    ...
    $sql ="SELECT * from user_backup";
        $res=$conn->query($sql);
        // echo $_SESSION["name"];
?>
    <h1>REMOVED USER LIST</h1>
    ...
    <table>
        ...
        if (isset($_POST['search_bg'])) {
            $bg=$_POST["bg"];
            $bg_sql ="SELECT * from user_backup where bloodgroup like '%$bg%'";
        ...
        <tr>
            ...
            <td>
            <?php
                echo "<a href='activate_user.php?id=$row[id]' class='act'>ACTIVATE</a>";
                ?>
            </td>
            <td>
            <?php
                echo "<a href='permanent_delete_user.php?id=$row[id]' class='del'>DELETE</a>";
                ?>
            </td>
        ...
        <tr>
         ...
         if (isset($_POST['search_city'])) {
            $city=$_POST["city"];
            $city_sql ="SELECT * from user_backup where city like '%$city%'";
